<script lang="ts">
    ...
    import CreateFolderModal from "./Sidebar/CreateFolderModal.svelte";
    import RenameFolderModal from "./Sidebar/RenameFolderModal.svelte";
    import DeleteFolderModal from "./Sidebar/DeleteFolderModal.svelte";
    import MoveFolderModal from "./Sidebar/MoveFolderModal.svelte";
